...
def wurzel(radikand, wurzelexponent):
    ...
    if radikand >= 1:
        while True:
            if border1 - border2 <= 1 and border1 - border2 >= -1:
            ...
            if guess_p == radikand:
                ...
                return(result)
                break
            elif border1 - border2 <= 0.00000000001 and border1 - border2 >= -0.00000000001:
                result = guess
                return(result)
                break
        ...
        while True:
            ...
            if guess_p == radikand:
                ...
                return(result)
                break
            elif border1 - border2 <= 0.0000000001 and border1 - border2 >= -0.0000000001:
                result = guess
                return(result)
                break
            elif guess_p > radikand:
